...
public class MessagePublisher {
    ...
    public MessagePublisher(ApplicationConfiguration configuration, Producer kafkaProducer) {
    ...
    public void publishMessage(String key, String msg) {
        try {
            ...
            e.printStackTrace();
            logger.info("Publishing to kafka failed due to InterruptedException. Message: " + msg);
